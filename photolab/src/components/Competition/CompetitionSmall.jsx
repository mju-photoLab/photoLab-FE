  ...
  return(
    <div className="w-[304px] h-[324px] relative mt-3 mx-[8px] bg-muteBg">
      <div className=" w-full h-full bg-gray-50 rounded-[10px] border border-solid">
        <img className="w-[304px] h-60 rounded-t-[10px] cursor-pointer object-cover" src={photoOne.imagePath} onClick={() => {navigate('/imageDetail', {state : photoOne.photoId})}}/>
        <div className=" flex w-full justify-between px-[26px] pt-[16px] items-start">
          <div className='flex'>
            ...
            <div className=" pl-4">
              <div className=' text-indigo-900 text-[15px] font-semibold font-["Pretendard"] mb-2 leading-[30px]' onClick={() => {navigate('/imageDetail', {state : photoOne.photoId})}}>{photoOne.title} - {photoOne.photographer}</div>
